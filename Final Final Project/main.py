...
# Game Board Configuration using TKinter
size_of_board = 600
number_of_dots = int(input("Enter the Size of the Game Grid (Ex: 3,4,5,6...): "))
...
class Dots_and_Boxes:
    ...
    # ------------------------------------------------------------------
    # Logical Functions:
    # Game Logic of the Dots and Boxes
    # ------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    print("1. LocalSearchPlayer vs RandomBot") 
    print("2. AdversarialSearchPlayer vs RandomBot")
    print("3. LocalSearchPlayer vs HumanPlayer")
    print("4. AdversarialSearchPlayer vs HumanPlayer")
    print("5. AdversarialSearchPlayer vs LocalSearchPlayer")

    while True:
        mode = input("Enter game mode (1-5): ")
        if mode in ["1", "2", "3", "4", "5"]:
            break
        print("Invalid input, please enter number 1-5")

    if mode == "1":
        game_instance = Dots_and_Boxes(LocalSearchPlayer(), RandomBot()) 
    elif mode == "2":
        game_instance = Dots_and_Boxes(AdversarialSearchPlayer(), RandomBot())
    elif mode == "3":
        game_instance = Dots_and_Boxes(LocalSearchPlayer(),None)
    elif mode == "4":
        game_instance = Dots_and_Boxes(AdversarialSearchPlayer(),None)
    elif mode == "5":
        game_instance = Dots_and_Boxes(AdversarialSearchPlayer(), LocalSearchPlayer())
    ...
    # '''runs LocalSearchPlayer vs RandomBot'''
    # #game_instance = Dots_and_Boxes(LocalSearchPlayer(),RandomBot())

    # '''runs AdversarialSearchPlayer vs RandomBot'''
    # #game_instance = Dots_and_Boxes(AdversarialSearchPlayer(),RandomBot())

    # '''runs LocalSearchPlayer vs HumanPlayer (Enjoy Beating our Easy Level Dificulty Bot with your BigBrain)'''
    # # game_instance = Dots_and_Boxes(LocalSearchPlayer(),None)

    # '''runs AdversarialSearchPlayer vs HumanPlayer (This is a head Scratcher, Most Difficult Player to Beat.
    # Run this game only if you can play it without breaking your screen)'''
    # # game_instance = Dots_and_Boxes(AdversarialSearchPlayer(),None)

    # '''runs AdversarialSearchPlayer (Rushi) vs LocalSearchPlayer (Lalit)'''
    # game_instance = Dots_and_Boxes(AdversarialSearchPlayer(),LocalSearchPlayer())
